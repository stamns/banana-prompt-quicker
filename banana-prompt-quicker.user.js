...
// @version      1.1.0
// @description  Prompts quicker is ALL you 🍌 need
// @author       Glidea
// @match        https://aistudio.google.com/*
// @match        https://gemini.google.com/*
// @icon         https://raw.githubusercontent.com/glidea/banana-prompt-quicker/main/extension/icon128.png
// @grant        GM_setValue
// @grant        GM_getValue
...
(function() {
    ...
    // Mock chrome.storage using GM_ functions
        ...
        if (typeof url === 'string' && url.includes('raw.githubusercontent.com')) {
            return new Promise((resolve, reject) => {
                GM_xmlhttpRequest({
                    ...
                    onerror: (error) => reject(new TypeError('Network request failed'))
                });
            });
        }
